...
--
-- Servidor: db
-- Tiempo de generación: 23-10-2025 a las 22:54:38
...
--
-- Base de datos: `sistema_horario_db`
--
...
CREATE TABLE `coordinaciones` (
  ...
  `alias_coordinacion` varchar(20) DEFAULT NULL,
...
INSERT INTO `coordinaciones` (`id_coordinacion`, `nombre_coordinacion`, `alias_coordinacion`, `id_sede`, `id_responsable`, `activo`) VALUES
(1, 'Santo Domingo', 'SD', 1, NULL, 0),
(2, 'Cuenca', 'CU', 2, NULL, 0),
(3, 'Quinindé', 'QUIN', 3, NULL, 0),
(4, 'SANTO DOMINGO', 'SD', 1, NULL, 1),
(5, 'QUININDE', 'QI', 3, NULL, 0),
(6, 'QUININDE', 'QI', 3, NULL, 1),
(7, 'CUENCA', '', 2, NULL, 0),
(8, 'CUENC', 'CU', 2, NULL, 0),
(9, 'CUENCA', 'CU', 2, NULL, 0),
(10, 'CUENCA', 'CU', 2, NULL, 0),
(11, 'CUENCA', 'CU', 2, NULL, 0);
...
--
-- Estructura de tabla para la tabla `grupo_permisos`
--
...
--
-- Volcado de datos para la tabla `grupo_permisos`
--

INSERT INTO `grupo_permisos` (`id_permiso`, `id_grupo`, `id_modulo`) VALUES
(23, 1, 9),
(24, 1, 3),
(171, 4, 12),
(172, 4, 9),
...
INSERT INTO `modulos` (`id_modulo`, `nombre_modulo`, `categoria`, `descripcion`, `icono_fa`, `url`) VALUES
(1, 'Talento Humano', 'Administración', 'Talento humano', 'fas fa-search-plus', 'talento_humano.php'),
(2, 'Grupos y Permisos', 'Administración', 'Gestión de grupos y permisos de usuarios', 'fas fa-users-cog', 'grupos.php'),
(3, 'Horarios', 'Académicos', 'Configuración de los horarios de clases', 'fas fa-clock', 'horarios.php'),
(4, 'Niveles y Materias', 'Académicos', 'Niveles y materias del periodo actual', 'fas fa-book', 'niveles.php'),
(5, 'Programas', 'Académicos', 'Gestión de programas que ofertamos', 'fas fa-graduation-cap', 'programas.php'),
(6, 'Mallas', 'Académicos', 'Mallas curriculares', 'fas fa-sitemap', 'mallas.php'),
(7, 'Coordinaciones', 'Administración', 'Registro de coordinaciones', 'fas fa-university', 'coordinaciones.php'),
(8, 'Periodos Lectivos', 'Administración', 'Administración de periodos lectivos', 'fas fa-calendar-check', 'periodos_lectivos.php'),
(9, 'Clases Impartidas', 'Académicos', 'Clases impartidas por los docentes', 'fas fa-chalkboard-teacher', 'clases_impartidas.php'),
(10, 'Profesores', 'Administración', 'Registro de profesores', 'fas fa-user-tie', 'profesores.php'),
(11, 'Sedes', 'Administración', 'Datos de las Sedes', 'fas fa-building-columns', 'sedes.php'),
(12, 'Administrativos', 'Administración', 'Personal administrativo', 'fas fa-users', 'administrativos.php'),
(13, 'Reportes', 'Más Módulos', 'Listado de reportes', 'fas fa-print', 'reportes.php');
...
INSERT INTO `periodos_lectivos` (`id_periodo`, `nombre_periodo`, `fecha_inicio`, `fecha_fin`, `activo`) VALUES
(1, 'Periodo Académico 2025 - I', '2025-03-01', '2025-08-15', 1),
(2, 'Periodo Académico 2025 - II', '2025-11-01', '2026-02-15', 0);
...
CREATE TABLE `sedes` (
  ...
  `id_canton` bigint DEFAULT NULL,
  `id_parroquia` bigint DEFAULT NULL,
...
INSERT INTO `sedes` (`id_sede`, `codigo_sede`, `nombre_sede`, `id_provincia`, `id_canton`, `id_parroquia`, `telefonos`, `direccion`, `activo`) VALUES
(1, 'SD', 'SEDE SANTO DOMINGO', 23, 2301, 230150, '0983099857', 'Av. 29 de Mayo y Tulcán', 1),
(2, 'CU', 'SEDE CUENCA', 1, 101, 10150, '0999999999', 'S/N', 1),
(3, 'QI', 'SEDE QUININDE	', 8, 804, 80450, '0999999999', 'S/N', 1),
(4, 'MA', 'SEDE MACHALA', 7, 701, 70150, '0999999999', 'S/N', 0),
(5, 'QE', 'SEDE QUEVEDO', 12, 1205, 120550, '0999999999', 'S/N', 1);
...
CREATE TABLE `tbl_canton` (
  `id` bigint NOT NULL,
  `canton` text CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `tbl_parroquia` (
  `id` bigint NOT NULL,
  `parroquia` text CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `tbl_provincia` (
  `id` bigint NOT NULL,
  `provincia` text CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
...
INSERT INTO `usuarios` (`id_usuario`, `nombre_completo`, `cedula`, `email`, `telefono`, `password`, `id_rol`, `id_sede`, `activo`) VALUES
(1, 'Jordan Espinosa', '2350637217', NULL, NULL, '$2y$10$i7tjF.kSRtGYZ1s/KjV15ueQDKs.FvABqM.1c8irToiu8xlyGeqQS', 1, NULL, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usuario_coordinacion_acceso`
--

CREATE TABLE `usuario_coordinacion_acceso` (
  `id` int NOT NULL,
  `id_usuario` int NOT NULL,
  `id_coordinacion` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Volcado de datos para la tabla `usuario_grupos`
--

INSERT INTO `usuario_grupos` (`id_usuario_grupo`, `id_usuario`, `id_grupo`) VALUES
(1, 1, 4);
...
ALTER TABLE `coordinaciones`
  ...
  ADD KEY `fk_coordinaciones_sedes_idx` (`id_sede`),
  ADD KEY `fk_coordinaciones_responsable_idx` (`id_responsable`);
...
--
-- Indices de la tabla `grupo_permisos`
--
ALTER TABLE `grupo_permisos`
  ADD PRIMARY KEY (`id_permiso`),
  ADD KEY `fk_permisos_grupos_idx` (`id_grupo`),
  ADD KEY `fk_permisos_modulos_idx` (`id_modulo`);
...
ALTER TABLE `sedes`
  ...
  ADD UNIQUE KEY `codigo_sede` (`codigo_sede`),
  ADD KEY `fk_sedes_provincia` (`id_provincia`),
  ADD KEY `fk_sedes_canton` (`id_canton`),
  ADD KEY `fk_sedes_parroquia` (`id_parroquia`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuarios_sedes` (`id_sede`);

--
-- Indices de la tabla `usuario_coordinacion_acceso`
--
ALTER TABLE `usuario_coordinacion_acceso`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_acceso_usuario_idx` (`id_usuario`),
  ADD KEY `fk_acceso_coordinacion_idx` (`id_coordinacion`);
...
ALTER TABLE `usuario_grupos`
  ...
  ADD KEY `fk_usuario_grupos_usuarios_idx` (`id_usuario`),
  ADD KEY `fk_usuario_grupos_grupos_idx` (`id_grupo`);
...
--
ALTER TABLE `coordinaciones`
  MODIFY `id_coordinacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT de la tabla `grupo_permisos`
--
ALTER TABLE `grupo_permisos`
  MODIFY `id_permiso` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;
...
--
ALTER TABLE `modulos`
  MODIFY `id_modulo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_canton`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9010;

--
-- AUTO_INCREMENT de la tabla `tbl_parroquia`
--
ALTER TABLE `tbl_parroquia`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=900952;
...
--
-- AUTO_INCREMENT de la tabla `usuario_coordinacion_acceso`
--
ALTER TABLE `usuario_coordinacion_acceso`
...
--
ALTER TABLE `usuario_grupos`
  MODIFY `id_usuario_grupo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `coordinaciones`
  ADD CONSTRAINT `fk_coordinaciones_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `usuarios` (`id_usuario`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_coordinaciones_sedes` FOREIGN KEY (`id_sede`) REFERENCES `sedes` (`id_sede`);

--
-- Filtros para la tabla `grupo_permisos`
--
ALTER TABLE `grupo_permisos`
  ADD CONSTRAINT `fk_permisos_grupos` FOREIGN KEY (`id_grupo`) REFERENCES `grupos` (`id_grupo`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_permisos_modulos` FOREIGN KEY (`id_modulo`) REFERENCES `modulos` (`id_modulo`) ON DELETE CASCADE;

--
-- Filtros para la tabla `sedes`
--
ALTER TABLE `sedes`
  ADD CONSTRAINT `fk_sedes_canton` FOREIGN KEY (`id_canton`) REFERENCES `tbl_canton` (`id`),
  ADD CONSTRAINT `fk_sedes_parroquia` FOREIGN KEY (`id_parroquia`) REFERENCES `tbl_parroquia` (`id`),
  ADD CONSTRAINT `fk_sedes_provincia` FOREIGN KEY (`id_provincia`) REFERENCES `tbl_provincia` (`id`);
...
--
-- Filtros para la tabla `usuario_coordinacion_acceso`
--
ALTER TABLE `usuario_coordinacion_acceso`
  ADD CONSTRAINT `fk_acceso_coordinacion` FOREIGN KEY (`id_coordinacion`) REFERENCES `coordinaciones` (`id_coordinacion`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_acceso_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE;

--
-- Filtros para la tabla `usuario_grupos`
--
ALTER TABLE `usuario_grupos`
  ADD CONSTRAINT `fk_usuario_grupos_grupos` FOREIGN KEY (`id_grupo`) REFERENCES `grupos` (`id_grupo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usuario_grupos_usuarios` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
